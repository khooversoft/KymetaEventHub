...
//public class MessageOrchestrationTestService : IBackgroundHost
//{
//    private readonly ILogger<MessageOrchestrationService> _logger;
//    private readonly IServiceProvider _serviceProvider;

//    public MessageOrchestrationTestService(IServiceProvider serviceProvider, ILogger<MessageOrchestrationService> logger)
//    {
...
//        hubWorker.AddTaskOrchestrations(new ActivityCreator<TaskOrchestration>(typeof(TestOrchestration), _serviceProvider));
//        hubWorker.AddTaskOrchestrations(new ActivityCreator<TaskOrchestration>(typeof(SubTestOrchestration), _serviceProvider));
//        //hubWorker.AddTaskOrchestrations(typeof(TestOrchestration));
//        //hubWorker.AddTaskOrchestrations(typeof(SubTestOrchestration));
//        hubWorker.AddTaskActivities(new ActivityCreator<TaskActivity>(typeof(TestActivity1), _serviceProvider));
//        hubWorker.AddTaskActivities(new ActivityCreator<TaskActivity>(typeof(TestActivity2), _serviceProvider));
//        hubWorker.AddTaskActivities(new ActivityCreator<TaskActivity>(typeof(TestActivity3), _serviceProvider));
//        hubWorker.AddTaskActivities(new ActivityCreator<TaskActivity>(typeof(TestActivity4), _serviceProvider));
