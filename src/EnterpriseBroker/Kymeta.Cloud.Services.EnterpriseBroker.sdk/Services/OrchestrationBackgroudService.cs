...
public class OrchestrationBackgroudService : BackgroundService
{
    ...
    public OrchestrationBackgroudService(MessageEventService salesForceEventListener, ServiceOption serviceOption, SalesforceClient2 client, ILogger<MessageEventBackgroundService> logger)
    {
